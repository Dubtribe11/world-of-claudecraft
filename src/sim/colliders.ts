...
import {
  ARENA_LAYOUT, CRYPT_LAYOUT, SANCTUM_LAYOUT, TEMPLE_LAYOUT, UNDERWORLD_LAYOUT,
  layoutColliders, underworldColliders,
} from './dungeon_layout';
...
const UNDERWORLD_COLLIDERS: Collider[] = underworldColliders(UNDERWORLD_LAYOUT);
...
const INTERIOR_COLLIDERS: Record<string, Collider[]> = {
  ...
  underworld: UNDERWORLD_COLLIDERS,
};
