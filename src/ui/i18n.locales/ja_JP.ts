...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.heading': 'アリーナ シーズン{season}',
  'hudChrome.arenaSeason.preseasonHeading': 'アリーナ プレシーズン',
  'hudChrome.arenaSeason.titleReward': 'シーズン称号: {title}',
  'hudChrome.arenaSeason.endsInDays': '残り{count}日',
  'hudChrome.arenaSeason.endsInHours': '残り{count}時間',
  'hudChrome.arenaSeason.endsInMinutes': '残り{count}分',
  'hudChrome.arenaSeason.opensInDays': '{count}日後に開幕',
  'hudChrome.arenaSeason.opensInHours': '{count}時間後に開幕',
  'hudChrome.arenaSeason.opensInMinutes': '{count}分後に開幕',
  'hudChrome.arenaSeason.progressLabel': 'シーズンの進行',
  'hudChrome.arenaSeason.champions': 'チャンピオン',
  'hudChrome.arenaSeason.seasonLabel': 'シーズン{season}',
  'hudChrome.arenaSeason.note':
    'シーズン終了時、1v1のレート最上位の闘士と2v2のレート最上位のペアがシーズン称号を獲得します。',
