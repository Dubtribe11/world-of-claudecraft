...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.heading': '투기장 시즌 {season}',
  'hudChrome.arenaSeason.preseasonHeading': '투기장 프리시즌',
  'hudChrome.arenaSeason.titleReward': '시즌 칭호: {title}',
  'hudChrome.arenaSeason.endsInDays': '{count}일 후 종료',
  'hudChrome.arenaSeason.endsInHours': '{count}시간 후 종료',
  'hudChrome.arenaSeason.endsInMinutes': '{count}분 후 종료',
  'hudChrome.arenaSeason.opensInDays': '{count}일 후 시작',
  'hudChrome.arenaSeason.opensInHours': '{count}시간 후 시작',
  'hudChrome.arenaSeason.opensInMinutes': '{count}분 후 시작',
  'hudChrome.arenaSeason.progressLabel': '시즌 진행도',
  'hudChrome.arenaSeason.champions': '챔피언',
  'hudChrome.arenaSeason.seasonLabel': '시즌 {season}',
  'hudChrome.arenaSeason.note':
    '시즌이 끝나면 1v1 최고 점수의 결투가와 2v2 최고 점수의 팀이 시즌 칭호를 얻습니다.',
