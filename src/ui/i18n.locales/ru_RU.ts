...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.heading': 'Арена: сезон {season}',
  'hudChrome.arenaSeason.preseasonHeading': 'Арена: предсезонье',
  'hudChrome.arenaSeason.titleReward': 'Титул сезона: {title}',
  'hudChrome.arenaSeason.endsInDays': 'Осталось дней: {count}',
  'hudChrome.arenaSeason.endsInHours': 'Осталось часов: {count}',
  'hudChrome.arenaSeason.endsInMinutes': 'Осталось минут: {count}',
  'hudChrome.arenaSeason.opensInDays': 'До начала дней: {count}',
  'hudChrome.arenaSeason.opensInHours': 'До начала часов: {count}',
  'hudChrome.arenaSeason.opensInMinutes': 'До начала минут: {count}',
  'hudChrome.arenaSeason.progressLabel': 'Ход сезона',
  'hudChrome.arenaSeason.champions': 'Чемпионы',
  'hudChrome.arenaSeason.seasonLabel': 'Сезон {season}',
  'hudChrome.arenaSeason.note':
    'По завершении сезона титул получают дуэлянт с наивысшим рейтингом 1v1 и пара с наивысшим рейтингом 2v2.',
