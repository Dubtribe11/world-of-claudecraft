...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.heading': '竞技场 第 {season} 赛季',
  'hudChrome.arenaSeason.preseasonHeading': '竞技场 季前赛',
  'hudChrome.arenaSeason.titleReward': '赛季头衔：{title}',
  'hudChrome.arenaSeason.endsInDays': '{count} 天后结束',
  'hudChrome.arenaSeason.endsInHours': '{count} 小时后结束',
  'hudChrome.arenaSeason.endsInMinutes': '{count} 分钟后结束',
  'hudChrome.arenaSeason.opensInDays': '{count} 天后开启',
  'hudChrome.arenaSeason.opensInHours': '{count} 小时后开启',
  'hudChrome.arenaSeason.opensInMinutes': '{count} 分钟后开启',
  'hudChrome.arenaSeason.progressLabel': '赛季进度',
  'hudChrome.arenaSeason.champions': '冠军',
  'hudChrome.arenaSeason.seasonLabel': '第 {season} 赛季',
  'hudChrome.arenaSeason.note':
    '赛季结束时，1v1 积分最高的斗士与 2v2 积分最高的组合将获得赛季头衔。',
