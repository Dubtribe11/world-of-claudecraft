...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.arenaSeason.heading': '競技場 第 {season} 賽季',
  'hudChrome.arenaSeason.preseasonHeading': '競技場 季前賽',
  'hudChrome.arenaSeason.titleReward': '賽季頭銜：{title}',
  'hudChrome.arenaSeason.endsInDays': '{count} 天後結束',
  'hudChrome.arenaSeason.endsInHours': '{count} 小時後結束',
  'hudChrome.arenaSeason.endsInMinutes': '{count} 分鐘後結束',
  'hudChrome.arenaSeason.opensInDays': '{count} 天後開啟',
  'hudChrome.arenaSeason.opensInHours': '{count} 小時後開啟',
  'hudChrome.arenaSeason.opensInMinutes': '{count} 分鐘後開啟',
  'hudChrome.arenaSeason.progressLabel': '賽季進度',
  'hudChrome.arenaSeason.champions': '冠軍',
  'hudChrome.arenaSeason.seasonLabel': '第 {season} 賽季',
  'hudChrome.arenaSeason.note':
    '賽季結束時，1v1 積分最高的鬥士與 2v2 積分最高的組合將獲得賽季頭銜。',
