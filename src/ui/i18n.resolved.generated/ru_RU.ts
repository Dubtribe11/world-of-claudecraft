...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "mobileAssistRotationGcdNote": "Способности, применённые кнопкой помощи, оставляют более длительное общее время восстановления, чем нажатые вручную, поэтому ротация идёт немного медленнее, чем при игре руками.",
